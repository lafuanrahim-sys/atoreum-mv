    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="bg-gold px-5 py-2 text-xs uppercase tracking-[0.15em] text-ink hover:bg-gold/90"
        >
          + Add Product
        </Link>
      </div>
        ...
        <tbody>
          {filtered.map((p) => (
            <tr key={p.id} className="border-b border-line/50">
              ...
              <td className="py-3 pr-4 text-ivory-dim">{formatPrice(p.price, p.currency)}</td>
